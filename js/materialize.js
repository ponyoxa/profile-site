...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  \**********************************************/
                /***/ (
                    ...
                    function spring(string, duration) {
                        ...
                        var mass = minMax(
                            is.und(params[0]) ? 1 : params[0],
                            0.1,
                            100
                        );
                        var stiffness = minMax(
                            is.und(params[1]) ? 100 : params[1],
                            0.1,
                            100
                        );
                        var damping = minMax(
                            is.und(params[2]) ? 10 : params[2],
                            0.1,
                            100
                        );
                        var velocity = minMax(
                            is.und(params[3]) ? 0 : params[3],
                            0.1,
                            100
                        );
                        ...
                        function solver(t) {
                            ...
                            if (zeta < 1) {
                                progress =
                                    ...
                                    (a * Math.cos(wd * progress) +
                                        b * Math.sin(wd * progress));
                            } else {
                                progress =
                                    (a + b * progress) *
                                    Math.exp(-progress * w0);
                            }
                            if (t === 0 || t === 1) {
                                return t;
                            }
                    ...
                    function steps(steps) {
                        ...
                        return function (t) {
                            return (
                                Math.ceil(minMax(t, 0.000001, 1) * steps) *
                                (1 / steps)
                            );
                        };
                    }
                    ...
                    var bezier = (function () {
                        ...
                        function bezier(mX1, mY1, mX2, mY2) {
                            ...
                            var sampleValues = new Float32Array(
                                kSplineTableSize
                            );
                        ...
                        var functionEasings = {
                            ...
                            Bounce: function () {
                                return function (t) {
                                    ...
                                    while (
                                        t <
                                        ((pow2 = Math.pow(2, --b)) - 1) / 11
                                    ) {}
                                    return (
                                        1 / Math.pow(4, 3 - b) -
                                        7.5625 *
                                            Math.pow((pow2 * 3 - 2) / 22 - t, 2)
                                    );
                                };
                            },
                    ...
                    function filterArray(arr, callback) {
                        var len = arr.length;
                        var thisArg =
                            arguments.length >= 2 ? arguments[1] : void 0;
                        var result = [];
                        for (var i = 0; i < len; i++) {
                            if (i in arr) {
                                var val = arr[i];
                    ...
                    function getAnimationType(el, prop) {
                        ...
                        if (
                            is.dom(el) &&
                            arrayContains(validTransforms, prop)
                        ) {
                            return "transform";
                        }
                        if (
                    ...
                    function getTransformValue(el, propName, animatable, unit) {
                        ...
                        var value =
                            getElementTransforms(el).get(propName) ||
                            defaultVal;
                        if (animatable) {
                    ...
                    function getOriginalTargetValue(
                        target,
                        propName,
                        unit,
                        animatable
                    ...
                    function getRectLength(el) {
                        return (
                            getAttribute(el, "width") * 2 +
                            getAttribute(el, "height") * 2
                        );
                    }
                    ...
                    function getPathProgress(
                        ...
                        function point(offset) {
                            ...
                            var l =
                                progress + offset >= 1 ? progress + offset : 0;
                    ...
                    function decomposeValue(val, unit) {
                        ...
                        var value =
                            validateValue(
                                is.pth(val) ? val.totalLength : val,
                                unit
                            ) + "";
                        return {
                            original: value,
                            numbers: value.match(rgx)
                                ? value.match(rgx).map(Number)
                                : [0],
                            strings:
                                is.str(val) || unit ? value.split(rgx) : [],
                        };
                    }
                    ...
                    function flattenKeyframes(keyframes) {
                        ...
                        var loop = function (i) {
                            ...
                            properties[propName] = keyframes.map(function (
                                key
                            ) {
                                var newKey = {};
                                for (var p in key) {
                    ...
                    function getProperties(tweenSettings, params) {
                        ...
                        for (var p in params) {
                            if (is.key(p)) {
                                properties.push({
                                    name: p,
                                    tweens: normalizePropertyTweens(
                                        params[p],
                                        tweenSettings
                                    ),
                                });
                    ...
                    function normalizeTweens(prop, animatable) {
                        ...
                        return prop.tweens.map(function (t) {
                            ...
                            var previousValue = previousTween
                                ...
                                : originalValue;
                            var from = is.arr(tweenValue)
                                ? tweenValue[0]
                                : previousValue;
                            var fromUnit =
                                getUnit(from) || getUnit(originalValue);
                            var unit = toUnit || fromUnit;
                            if (is.und(to)) {
                                to = previousValue;
                            }
                            tween.from = decomposeValue(from, unit);
                            tween.to = decomposeValue(
                    ...
                    function createNewInstance(params) {
                        ...
                        var tweenSettings = replaceObjectProps(
                        ...
                        var timings = getInstanceTimings(
                            animations,
                            tweenSettings
                        );
                        var id = instanceID;
                    ...
                    var engine = (function () {
                        ...
                        function step(t) {
                            ...
                            raf =
                                i > 0 ? requestAnimationFrame(step) : undefined;
                        }
                    ...
                    function anime(params) {
                        ...
                        function resetTime() {
                            startTime = 0;
                            lastTime =
                                adjustTime(instance.currentTime) *
                                (1 / anime.speed);
                        }
                        ...
                        function setAnimationsProgress(insTime) {
                            ...
                            while (i < animationsLength) {
                                ...
                                var eased = isNaN(elapsed)
                                    ? 1
                                    : tween.easing(elapsed);
                        ...
                        function setInstanceProgress(engineTime) {
                            ...
                            instance.progress = minMax(
                                (insTime / insDuration) * 100,
                                0,
                                100
                            );
                            instance.reversePlayback =
                                insTime < instance.currentTime;
                            if (children) {
                        ...
                        instance.tick = function (t) {
                            ...
                            setInstanceProgress(
                                (now + (lastTime - startTime)) * anime.speed
                            );
                        };
                    ...
                    function removeTargetsFromAnimations(
                        targetsArray,
                        animations
                    ) {
                        for (var a = animations.length; a--; ) {
                            if (
                                arrayContains(
                                    targetsArray,
                                    animations[a].animatable.target
                                )
                            ) {
                    ...
                    function stagger(val, params) {
                        ...
                        return function (el, i, t) {
                            ...
                            return (
                                start +
                                spacing * (Math.round(values[i] * 100) / 100) +
                                unit
                            );
                        };
                    }
                    ...
                    function timeline(params) {
                        ...
                        tl.add = function (instanceParams, timelineOffset) {
                            ...
                            insParams.targets =
                                insParams.targets || params.targets;
  ...
  \*****************************/
                /***/ (
                    ...
                    const dropdown_1 = __webpack_require__(
                    ...
                    class Autocomplete extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleInputKeyupAndFocus = (e) => {
                                ...
                                this.count = 0;
                                const actualValue =
                                    this.el.value.toLocaleLowerCase();
                                // Don't capture enter or arrow key usage.
                                if (
                                    utils_1.Utils.keys.ENTER.includes(e.key) ||
                                    utils_1.Utils.keys.ARROW_UP.includes(
                                        e.key
                                    ) ||
                                    utils_1.Utils.keys.ARROW_DOWN.includes(
                                        e.key
                                    )
                                )
                                    return;
                            ...
                            this._handleInputKeydown = (e) => {
                                ...
                                if (
                                    ...
                                    if (liElement) {
                                        this.selectOption(
                                            liElement.getAttribute("data-id")
                                        );
                                        e.preventDefault();
                                    }
                                    return;
                            ...
                            this.open = () => {
                                ...
                                this._resetAutocomplete();
                                if (
                                    inputText.length >= this.options.minLength
                                ) {
                                    this.isOpen = true;
                            ...
                            this.options = Object.assign(
                                Object.assign({}, Autocomplete.defaults),
                                options
                            );
                            this.isOpen = false;
                            this.count = 0;
                        ...
                        _setupEventHandlers() {
                            ...
                            this.el.addEventListener(
                                "keyup",
                                this._handleInputKeyupAndFocus
                            );
                            this.el.addEventListener(
                                "focus",
                                this._handleInputKeyupAndFocus
                        ...
                        _setupDropdown() {
                            ...
                            this.container.style.maxHeight =
                                this.options.maxDropDownHeight;
                            ...
                            // Initialize dropdown
                            let dropdownOptions = Object.assign(
                                Object.assign(
                                    {},
                            ...
                            dropdownOptions.onItemClick = (li) => {
                                ...
                                if (
                                    userOnItemClick &&
                                    typeof userOnItemClick === "function"
                                )
                                    userOnItemClick.call(
                                        this.dropdown,
                                        this.el
                                    );
                            };
                            this.dropdown = dropdown_1.Dropdown.init(
                                this.el,
                                dropdownOptions
                            );
                            ...
                            const label =
                                this.el.parentElement.querySelector("label");
                            if (label) this.el.after(label);
                            // Sketchy removal of dropdown click handler
                            this.el.removeEventListener(
                                "click",
                                this.dropdown._handleClick
                            );
        ...
        <input type="checkbox"${
            this.selectedValues.some((sel) => sel.id === entry.id)
                ? ' checked="checked"'
                : ""
                            ...
                            const parts = this._highlightPartialText(
                                inputText,
                                (entry.text || entry.id).toString()
                            );
                            const div = document.createElement("div");
                            div.setAttribute(
                                "style",
                            ...
                            if (
                                ...
                                item.querySelector(".item-text").appendChild(
                                    description
                                );
                            }
                            // Set Grid
                        ...
                        _renderDropdown() {
                            ...
                            for (let i = 0; i < this.menuItems.length; i++) {
                                const item = this._createDropdownItem(
                                    this.menuItems[i]
                                );
    ...
    <circle fill="#888c" stroke="none" cx="46" cy="50" r="6"><animate attributeName="opacity" dur="1s" values="0;1;0" repeatCount="indefinite"  begin="0.3"/></circle>
                            ...
                            if (statusElement) {
                                if (this.options.isMultiSelect)
                                    statusElement.innerHTML =
                                        this.selectedValues.length.toString();
                        ...
                        _triggerChanged() {
                            ...
                            if (
                                typeof this.options.onAutocomplete ===
                                "function"
                            )
                         ...
                         */
                        selectOption(id) {
                            const entry = this.menuItems.find(
                                (item) => item.id == id
                            );
                            if (!entry) return;
                            // Toggle Checkbox
                            const li = this.container.querySelector(
                                'li[data-id="' + id + '"]'
                            );
                            if (!li) return;
                            if (this.options.isMultiSelect) {
  ...
  \************************/
                /***/ function (
                    ...
                    const animejs_1 = __importDefault(
                        __webpack_require__(
                    ...
                    class FloatingActionButton extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._floatingBtnsReverse =
                                this._floatingBtns.reverse();
                            this.offsetY = 0;
                            this.offsetX = 0;
                        ...
                        _animateInToolbar() {
                            ...
                            const fabColor = getComputedStyle(
                                this._anchor
                                    ...
                                    document.body.addEventListener(
                                        ...
                                        (e) => {
                                            ...
                                            const initialOverflow =
                                                getComputedStyle(card).overflow;
                                            // Close Card
                                            const closeArea =
                                                cardReveal.querySelector(
                                                    ".card-reveal .card-title"
                                                );
                                            if (
                                                trigger === closeArea ||
                                                closeArea.contains(trigger)
                                            ) {
                                                (0, animejs_1.default)({
                                                    targets: cardReveal,
                                                    translateY: 0,
                    ...
                    class Carousel extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleCarouselRelease = (e) => {
                                ...
                                this.target =
                                    Math.round(this.target / this.dim) *
                                    this.dim;
                                // No wrap of items.
                                if (this.noWrap) {
                                    if (
                            ...
                            this._handleCarouselClick = (e) => {
                                ...
                                if (this.dragged) {
                                    ...
                                    const clickedIndex = [
                                        ...clickedElem.parentNode.children,
                                    ].indexOf(clickedElem);
                                    const diff =
                            ...
                            this._handleIndicatorClick = (e) => {
                                e.stopPropagation();
                                const indicator =
                                    e.target.closest(".indicator-item");
                                if (indicator) {
                                    const index = [
                                        ...indicator.parentNode.children,
                                    ].indexOf(indicator);
                                    this._cycleTo(index);
                                }
                            };
                            ...
                            this.options = Object.assign(
                                Object.assign({}, Carousel.defaults),
                                options
                            );
                            // Setup
                            ...
                            this.showIndicators =
                                ...
                                this.hasMultipleSlides;
                            this.noWrap =
                                this.options.noWrap || !this.hasMultipleSlides;
                            this.pressed = false;
                            this.dragged = false;
                            ...
                            this.dim =
                                this.itemWidth * 2 + this.options.padding || 1; // Make sure dim is non zero for divisions.
                            ...
                            if (this.options.fullWidth) {
                                ...
                                if (this.showIndicators) {
                                    (_a = this.el.querySelector(
                                        ".carousel-fixed-item"
                                    )) === null || _a === void 0
                                        ? void 0
                                        : _a.classList.add("with-indicators");
                                }
                            }
                        ...
                        _setupEventHandlers() {
                            if (typeof window.ontouchstart !== "undefined") {
                                this.el.addEventListener(
                                    "touchstart",
                                    this._handleCarouselTap
                                );
                                this.el.addEventListener(
                                    "touchmove",
                                    this._handleCarouselDrag
                                );
                                this.el.addEventListener(
                                    "touchend",
                                    this._handleCarouselRelease
                                );
                            }
                            this.el.addEventListener(
                                "mousedown",
                        ...
                        _setCarouselHeight(imageOnly = false) {
                            const firstSlide = this.el.querySelector(
                                ".carousel-item.active"
                            )
                        ...
                        _scroll(x = 0) {
                            ...
                            if (this.showIndicators) {
                                ...
                                const activeIndicator =
                                    this._indicators.querySelector(
                                        ".indicator-item.active"
                                    );
                                const activeIndicatorIndex = [
                                    ...activeIndicator.parentNode.children,
                                ].indexOf(activeIndicator);
                                if (activeIndicatorIndex !== diff) {
                                    activeIndicator.classList.remove("active");
                                    const pos =
                                        diff < 0 ? this.count + diff : diff;
                                    this._indicators
                                        .querySelectorAll(".indicator-item")
                            ...
                            for (i = 1; i <= half; ++i) {
                                ...
                                if (
                                    !this.noWrap ||
                                    this.center + i < this.count
                                ) {
                                    el =
                                        this.images[
                                            this._wrap(this.center + i)
                                        ];
                                    let transformString = `${alignment} translateX(${
                                        this.options.shift +
                                        (this.dim * i - delta) / 2
                        ...
                        constructor(el, options) {
                            ...
                            this.updateCounter = () => {
                                let maxLength = parseInt(
                                        this.el.getAttribute("maxlength")
                                    ),
                            ...
                            this.options = Object.assign(
                                Object.assign({}, CharacterCounter.defaults),
                                options
                            );
  ...
  \**********************/
                /***/ (
                    ...
                    const autocomplete_1 = __webpack_require__(
                    ...
                    class Chips extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleInputKeydown = (e) => {
                                ...
                                if (utils_1.Utils.keys.ENTER.includes(e.key)) {
                                    ...
                                    if (
                                        !this.hasAutocomplete ||
                                        (this.hasAutocomplete &&
                                            !this.options.autocompleteOnly)
                                    ) {
                                        this.addChip({ id: this._input.value });
                                    }
                                    this._input.value = "";
                                } else if (
                                    (utils_1.Utils.keys.BACKSPACE.includes(
                                        e.key
                                    ) ||
                                        utils_1.Utils.keys.ARROW_LEFT.includes(
                                            e.key
                                        )) &&
                                    this._input.value === "" &&
                            ...
                            this._setupInput();
                            this.hasAutocomplete =
                                Object.keys(this.options.autocompleteOptions)
                                    .length > 0;
                            // Set input id
                        ...
                        static _handleChipsKeydown(e) {
                            ...
                            if (
                                utils_1.Utils.keys.BACKSPACE.includes(e.key) ||
                                utils_1.Utils.keys.DELETE.includes(e.key)
                            ) {
                                e.preventDefault();
                                let selectIndex = currChips.chipsData.length;
                                if (currChips._selectedChip) {
                                    const index = gGetIndex(
                                ...
                                utils_1.Utils.keys.ARROW_LEFT.includes(e.key)
                            ) {
                                if (currChips._selectedChip) {
                                    const selectIndex =
                                        gGetIndex(currChips._selectedChip) - 1;
                                    if (selectIndex < 0) return;
                                    currChips.selectChip(selectIndex);
                                }
                            } else if (
                                utils_1.Utils.keys.ARROW_RIGHT.includes(e.key)
                            ) {
                                if (currChips._selectedChip) {
                                    const selectIndex =
                                        gGetIndex(currChips._selectedChip) + 1;
                        ...
                        _renderChips() {
                            ...
                            for (let i = 0; i < this.chipsData.length; i++) {
                                const chipElem = this._renderChip(
                                    this.chipsData[i]
                                );
                        ...
                        _setupAutocomplete() {
                            ...
                            this.autocomplete =
                                autocomplete_1.Autocomplete.init(
                                    this._input,
                        ...
                        _isValidAndNotExist(chip) {
                            ...
                            const doesNotExist = !this.chipsData.some(
                                    ...
                                    document.body.addEventListener(
                                        ...
                                        (e) => {
                                            if (
                                                ...
                                                const chips =
                                                    e.target.closest(".chips");
                                                if (
                                                    chips &&
                                                    chips.M_Chips == undefined
                                                )
                                                    return;
                                                e.target
                                                    .closest(".chip")
                ...
                /***/ function (
                    ...
                    class Collapsible extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this.open = (index) => {
                                ...
                                if (li && !li.classList.contains("active")) {
                                    ...
                                    if (this.options.accordion) {
                                        const activeLis = listItems.filter(
                                            (li) =>
                                                li.classList.contains("active")
                                        );
                                        activeLis.forEach((activeLi) => {
                                            const index =
                                                listItems.indexOf(activeLi);
                                            this.close(index);
                                        });
                                    }
                                    // Animate in
                             ...
                             */
                            this.close = (index) => {
                                const li = Array.from(this.el.children).filter(
                                    (c) => c.tagName === "LI"
                                )[index];
                                if (li && li.classList.contains("active")) {
                            ...
                            this.options = Object.assign(
                                Object.assign({}, Collapsible.defaults),
                                options
                            );
                            // Setup tab indices
                            ...
                            if (this.options.accordion)
                                if (activeBodies.length > 0)
                                    activeBodies[0].style.display = "block";
                                // Accordion
                                else
                                    activeBodies.forEach(
                        ...
                        _setupEventHandlers() {
                            this.el.addEventListener(
                                "click",
                                this._handleCollapsibleClick
                            );
                            this._headers.forEach((header) =>
                                header.addEventListener(
                                    "keydown",
                                    this._handleCollapsibleKeydown
                                )
                            );
                        }
                        _removeEventHandlers() {
                        ...
                        _animateIn(index) {
                            ...
                            const pBottom =
                                getComputedStyle(body).paddingBottom; //body.css('padding-bottom');
                        ...
                        _animateOut(index) {
                            ...
                            (0, animejs_1.default)({
                                ...
                                complete: () => {
                                    ...
                                    // onCloseEnd callback
                                    if (
                                        typeof this.options.onCloseEnd ===
                                        "function"
                                    ) {
                    ...
                    class Component {
                        ...
                        constructor(el, options, classDef) {
                            ...
                            if (!(el instanceof HTMLElement)) {
                                console.error(
                                    Error(el + " is not an HTML Element")
                                );
                            }
  ...
  \***************************/
                /***/ (
                    ...
                    const modal_1 = __webpack_require__(
                        /*! ./modal */ "./src/modal.ts"
                    );
                    const utils_1 = __webpack_require__(
                        /*! ./utils */ "./src/utils.ts"
                    );
                    const select_1 = __webpack_require__(
                    ...
                    class Datepicker extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleInputChange = (e) => {
                                ...
                                if (this.options.parse) {
                                    date = this.options.parse(
                                        this.el.value,
                                        typeof this.options.format ===
                                            "function"
                                            ? this.options.format(
                                                  new Date(this.el.value)
                                              )
                                            : this.options.format
                                    );
                                } else {
                            ...
                            if (
                                ...
                                this.options.i18n = Object.assign(
                                    Object.assign({}, Datepicker.defaults.i18n),
                                    options.i18n
                                );
                            }
                        ...
                        destroySelects() {
                            ...
                            if (oldYearSelect) {
                                select_1.FormSelect.getInstance(
                                    oldYearSelect
                                ).destroy();
                            }
                            let oldMonthSelect =
                        ...
                        _renderDateDisplay() {
                            let displayDate = Datepicker._isDate(this.date)
                                ? this.date
                                : new Date();
                            let i18n = this.options.i18n;
                            let day = i18n.weekdaysShort[displayDate.getDay()];
                            let month =
                                i18n.monthsShort[displayDate.getMonth()];
                            let date = displayDate.getDate();
                            this.yearTextEl.innerHTML = displayDate
                                .getFullYear()
                                .toString();
                            ...
                            for (let i = 0, r = 0; i < cells; i++) {
                                let day = new Date(
                                    ...
                                    isSelected = Datepicker._isDate(this.date)
                                        ...
                                        : false,
                                    isToday = Datepicker._compareDates(
                                        day,
                                        now
                                    ),
                                    hasEvent =
                        ...
                        _setupVariables() {
                            ...
                            this.formats = {
                                ...
                                yy: () => {
                                    return ("" + this.date.getFullYear()).slice(
                                        2
                                    );
                                },
                                yyyy: () => {
                    ...
                    class Dropdown extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleMouseLeave = (e) => {
                                ...
                                const leaveToDropdownContent =
                                    !!toEl.closest(".dropdown-content");
                            ...
                            this._handleDropdownKeydown = (e) => {
                                const arrowUpOrDown =
                                    ...
                                    utils_1.Utils.keys.ARROW_UP.includes(e.key);
                                ...
                                // Close dropdown on ESC
                                    ...
                                    utils_1.Utils.keys.ESC.includes(e.key) &&
                                    this.isOpen
                                ) {
                                    e.preventDefault();
                                    this.close();
                                ...
                                const specialKeys = [
                                    ...utils_1.Utils.keys.ARROW_DOWN,
                                    ...utils_1.Utils.keys.ARROW_UP,
                                    ...utils_1.Utils.keys.ENTER,
                                    ...utils_1.Utils.keys.ESC,
                                    ...utils_1.Utils.keys.TAB,
                                ];
                                if (isLetter && !specialKeys.includes(e.key)) {
                                    this.filterQuery.push(keyText);
                                    const string = this.filterQuery.join("");
                                    const newOptionEl = Array.from(
                                        this.dropdownEl.querySelectorAll("li")
                                    ).find(
                                        (el) =>
                                            el.innerText
                                                .toLowerCase()
                                    ...
                                    if (newOptionEl) {
                                        this.focusedIndex = [
                                            ...newOptionEl.parentNode.children,
                                        ].indexOf(newOptionEl);
                                        this._focusFocusedItem();
                                    }
                                }
                            ...
                            this.options = Object.assign(
                                Object.assign({}, Dropdown.defaults),
                                options
                            );
                            this.isOpen = false;
                        ...
                        _setupEventHandlers() {
                            ...
                            // Item click handler
                            (_a = this.dropdownEl) === null || _a === void 0
                                ? void 0
                                : _a.addEventListener(
                                      "click",
                        ...
                        _makeDropdownFocusable() {
                            ...
                            Array.from(this.dropdownEl.children).forEach(
                                (el) => {
                        ...
                        _getDropdownPosition(closestOverflowParent) {
                            ...
                            let idealXPos =
                                triggerBRect.left - dropdownBRect.left;
                            let idealYPos =
                                triggerBRect.top - dropdownBRect.top;
                            ...
                            const alignments =
                                utils_1.Utils.checkPossibleAlignments(
                                    this.el,
                        ...
                        _placeDropdown() {
                            ...
                            if (!closestOverflowParent) {
                                closestOverflowParent = !!this.dropdownEl
                                    .offsetParent
                                    ? this.dropdownEl.offsetParent
                                    : this.dropdownEl.parentNode;
                            }
                            if (
                                getComputedStyle(closestOverflowParent)
                                    .position === "static"
                            )
                                closestOverflowParent.style.position =
                                    "relative";
                        ...
                        static textareaAutoResize(textarea) {
                            ...
                            if (
                                ...
                                hiddenDiv.style.width =
                                    ...
                                    "px"; // ('width', textarea.width() + 'px');
                            } else {
                                hiddenDiv.style.width =
                                    window.innerWidth / 2 + "px"; //css('width', window.innerWidth / 2 + 'px');
                            }
                            // Resize if the new height is greater than the
                            // original height of the textarea
                            const originalHeight = parseInt(
                                textarea.getAttribute("original-height")
                            );
                            const prevLength = parseInt(
                                textarea.getAttribute("previous-length")
                            );
                            if (isNaN(originalHeight)) return;
                            if (originalHeight <= hiddenDiv.clientHeight) {
                                textarea.style.height =
                                    hiddenDiv.clientHeight + "px"; //css('height', hiddenDiv.innerHeight() + 'px');
                                ...
                                () => {
                                    document.addEventListener("keyup", (e) => {
                                        ...
                                        if (
                                            ...
                                            if (
                                                utils_1.Utils.keys.TAB.includes(
                                                    e.key
                                                )
                                            ) {
                    ...
                    class Materialbox extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this.open = () => {
                                ...
                                this._overlay.style.left =
                                    -1 * overlayOffset.left + "px";
                                this._overlay.style.top =
                                    -1 * overlayOffset.top + "px";
                                ...
                                if (this.caption !== "") {
                                    ...
                                    this._photoCaption.classList.add(
                                        "materialbox-caption"
                                    );
                            ...
                            this.options = Object.assign(
                                Object.assign({}, Materialbox.defaults),
                                options
                            );
                            this.overlayActive = false;
                        ...
                        _animateImageIn() {
                            this.el.style.maxHeight =
                                this.newHeight.toString() + "px";
                            this.el.style.maxWidth =
                                this.newWidth.toString() + "px";
                            const animOptions = {
                                targets: this.el,
                                height: [this.originalHeight, this.newHeight],
                                width: [this.originalWidth, this.newWidth],
                                left:
                                    utils_1.Utils.getDocumentScrollLeft() +
                                    this.windowWidth / 2 -
                                    this._offset(this.placeholder).left -
                                    this.newWidth / 2,
                                top:
                                    utils_1.Utils.getDocumentScrollTop() +
                                    this.windowHeight / 2 -
                            ...
                            const animOptions = {
                                ...
                                complete: () => {
                                    ...
                                    if (this.attrWidth)
                                        this.el.setAttribute(
                                            "width",
                                            this.attrWidth.toString()
                                        );
                                    if (this.attrHeight)
                                        this.el.setAttribute(
                                            "height",
                                            this.attrHeight.toString()
                                        );
                                    this.el.removeAttribute("style");
                                    this.originInlineStyles &&
                                        this.el.setAttribute(
                                    ...
                                    this._changedAncestorList.forEach(
                                        (anchestor) =>
                                            (anchestor.style.overflow = "")
                                    );
                                    // onCloseEnd callback
                                    if (
                                        typeof this.options.onCloseEnd ===
                    ...
                    class Modal extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleTriggerClick = (e) => {
                                ...
                                if (!trigger) return;
                                const modalId =
                                    utils_1.Utils.getIdFromTrigger(trigger);
                                const modalInstance =
                ...
                /***/ (
                    ...
                    class Parallax extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this.options = Object.assign(
                                Object.assign({}, Parallax.defaults),
                                options
                            );
                            this._enabled =
                                window.innerWidth >
                        ...
                        _updateParallax() {
                            ...
                            const bottom =
                                this._offset(this.el).top + containerHeight;
                ...
                /***/ (
                    ...
                    class Pushpin extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this.options = Object.assign(
                                Object.assign({}, Pushpin.defaults),
                                options
                            );
                        ...
                        _updatePosition() {
                            ...
                            if (
                                ...
                                this.el.style.top = `${
                                    this.options.bottom - this.originalOffset
                                }px`;
                                // onPositionChange callback
                                if (
                                    typeof this.options.onPositionChange ===
                    ...
                    class Range extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleRangeInputMousemoveTouchmove = () => {
                                if (this._mousedown) {
                                    if (
                                        !this.thumb.classList.contains("active")
                                    ) {
                                        this._showRangeBubble();
                                    }
                                    const offsetLeft = this._calcRangeOffset();
                            ...
                            this._handleRangeBlurMouseoutTouchleave = () => {
                                if (!this._mousedown) {
                                    const paddingLeft = parseInt(
                                        getComputedStyle(this.el).paddingLeft
                                    );
                        ...
                        _showRangeBubble() {
                            const paddingLeft = parseInt(
                                getComputedStyle(this.thumb.parentElement)
                                    .paddingLeft
                            );
                        ...
                        _calcRangeOffset() {
                            const width =
                                this.el.getBoundingClientRect().width - 15;
                            const max =
                                parseFloat(this.el.getAttribute("max")) || 100; // Range default max
                            const min =
                                parseFloat(this.el.getAttribute("min")) || 0; // Range default min
                            const percent =
                                (parseFloat(this.el.value) - min) / (max - min);
                ...
                /***/ function (
                    ...
                    class ScrollSpy extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleThrottledResize =
                                utils_1.Utils.throttle(function () {
                                    this._handleWindowScroll();
                                }, 200).bind(this);
                            this._handleTriggerClick = (e) => {
                                const trigger = e.target;
                                for (
                                    let i = ScrollSpy._elements.length - 1;
                                    i >= 0;
                                    i--
                                ) {
                                    const scrollspy = ScrollSpy._elements[i];
                                    const x = document.querySelector(
                                        'a[href="#' + scrollspy.el.id + '"]'
                                    );
                                    if (trigger === x) {
                                        e.preventDefault();
                                        const offset =
                                            ScrollSpy._offset(scrollspy.el)
                                                .top + 1;
                                        (0, animejs_1.default)({
                                            targets: [
                                            ...
                                            scrollTop:
                                                offset -
                                                scrollspy.options.scrollOffset,
                                            duration: 400,
                                            easing: "easeOutCubic",
                                        });
                                        break;
                            ...
                            this._handleWindowScroll = () => {
                                ...
                                ScrollSpy._ticks++;
                                // viewport rectangle
                                let top = utils_1.Utils.getDocumentScrollTop(),
                                    left =
                                        utils_1.Utils.getDocumentScrollLeft(),
                                    right = left + window.innerWidth,
                                    bottom = top + window.innerHeight;
                                // determine which elements are in view
                                let intersections = ScrollSpy._findElements(
                                    top,
                                    right,
                                    bottom,
                                    left
                                ...
                                for (
                                    let i = 0;
                                    i < ScrollSpy._elementsInView.length;
                                    i++
                                ) {
                                    let scrollspy =
                                        ScrollSpy._elementsInView[i];
                                    let lastTick = scrollspy.tickId;
                                    if (
                                        lastTick >= 0 &&
                                        lastTick !== ScrollSpy._ticks
                                    ) {
                                        // exited from view
                                        scrollspy._exit();
                                        scrollspy.tickId = -1;
                            ...
                            this.options = Object.assign(
                                Object.assign({}, ScrollSpy.defaults),
                                options
                            );
                        ...
                        destroy() {
                            ...
                            const actElem = document.querySelector(
                                this.options.getActiveElement(this.el.id)
                            );
                        ...
                        static _findElements(top, right, bottom, left) {
                            ...
                            for (
                                ...
                                if (
                                    scrollspy.el.getBoundingClientRect()
                                        .height > 0
                                ) {
                                    let elTop = ScrollSpy._offset(
                                            scrollspy.el
                                        ).top,
                                        elLeft = ScrollSpy._offset(
                                            scrollspy.el
                                        ).left,
                                        elRight =
                                            elLeft +
                        ...
                        _enter() {
                            ...
                            ScrollSpy._visibleElements =
                                ScrollSpy._visibleElements.filter(
                                    (value) =>
                            ...
                            if (ScrollSpy._visibleElements[0]) {
                                const actElem = document.querySelector(
                                    this.options.getActiveElement(
                                        ScrollSpy._visibleElements[0].id
                                    )
                                );
                                actElem === null || actElem === void 0
                                    ? void 0
                            ...
                            const selector = this.options.getActiveElement(
                                ScrollSpy._visibleElements[0].id
                            );
                            (_a = document.querySelector(selector)) === null ||
                            _a === void 0
                                ? void 0
                                : _a.classList.add(this.options.activeClass);
                        }
                        _exit() {
                            var _a;
                            ScrollSpy._visibleElements =
                            ...
                            if (ScrollSpy._visibleElements[0]) {
                                ...
                                if (ScrollSpy._visibleElements[0]) {
                                    ...
                                    (_a = document.querySelector(selector)) ===
                                        null || _a === void 0
                                        ? void 0
                                        : _a.classList.add(
                                              this.options.activeClass
                ...
                /***/ (
                    ...
                    class FormSelect extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this.options = Object.assign(
                                Object.assign({}, FormSelect.defaults),
                                options
                            );
                        ...
                        _selectOptionElement(virtualOption) {
                            if (
                                ...
                                const value = this._values.find(
                                    (value) => value.optionEl === virtualOption
                                );
                        ...
                        _setupDropdown() {
                            ...
                            this.selectOptions = Array.from(
                                ...
                                ["OPTION", "OPTGROUP"].includes(el.tagName)
                            );
                            // Create dropdown
                            ...
                            this.dropdownOptions.setAttribute(
                                "role",
                                "listbox"
                            );
                            this.dropdownOptions.ariaMultiSelectable =
                                this.isMultiple.toString();
                            if (this.isMultiple)
                                this.dropdownOptions.classList.add(
                            ...
                            if (this.selectOptions.length > 0) {
                                this.selectOptions.forEach((realOption) => {
                                    if (realOption.tagName === "OPTION") {
                                        // Option
                                        const virtualOption =
                                            this._createAndAppendOptionWithIcon(
                                                realOption,
                                                this.isMultiple
                                                    ? "multiple"
                                                    : undefined
                                            );
                                        this._addOptionToValues(
                                            realOption,
                                            virtualOption
                                        );
                                    } else if (
                                        realOption.tagName === "OPTGROUP"
                                    ) {
                                        // Optgroup
                                        const groupId =
                                            "opt-group-" + utils_1.Utils.guid();
                                        const groupParent =
                                            document.createElement("li");
                            ...
                            this.input.id =
                                "m_select-input-" + utils_1.Utils.guid();
                            ...
                            this.input.ariaRequired = this.el
                                .hasAttribute("required")
                                .toString(); //setAttribute("aria-required", this.el.hasAttribute("required"));
                            ...
                            if (this.labelEl) {
                                ...
                                this.labelEl.id =
                                    "m_select-label-" + utils_1.Utils.guid();
                                this.dropdownOptions.setAttribute(
                                    "aria-labelledby",
                                    this.labelEl.id
                                );
        ...
        */
                            ...
                            if (!this.el.disabled) {
                                ...
                                dropdownOptions.onOpenEnd = (el) => {
                                    ...
                                    if (selectedOption) {
                                        ...
                                        if (this.dropdown.isScrollable) {
                                            ...
                                            scrollOffset -=
                                                this.dropdownOptions
                                                    .clientHeight / 2; // center in dropdown
                                            this.dropdownOptions.scrollTop =
                                                scrollOffset;
                                        }
                                    }
                                ...
                                dropdownOptions.onCloseEnd = (el) => {
                                    ...
                                    if (
                                        userOnCloseEnd &&
                                        typeof userOnCloseEnd === "function"
                                    )
                                        userOnCloseEnd.call(
                                            this.dropdown,
                                            this.el
                        ...
                        _createAndAppendOptionWithIcon(realOption, type) {
                            ...
                            // add Icon
                            const iconUrl =
                                realOption.getAttribute("data-icon");
                            const classes =
                                (_a = realOption.getAttribute("class")) ===
                                    null || _a === void 0
                                    ? void 0
                                    : _a.split();
                            if (iconUrl) {
                        ...
                        _selectValue(value) {
                            ...
                            const checkbox = value.optionEl.querySelector(
                                'input[type="checkbox"]'
                            );
                        ...
                        _isValueSelected(value) {
                            ...
                            return realValues.some(
                                (realValue) => realValue === value.el.value
                            );
                        }
                        ...
                        _setValueToInput() {
                            ...
                            const values = this._values.filter(
                                (value) => realOptions.indexOf(value.el) >= 0
                            );
                            ...
                            if (texts.length === 0) {
                                const firstDisabledOption =
                                    this.el.querySelector("option:disabled");
                                if (
                                    firstDisabledOption &&
                                    firstDisabledOption.value === ""
                                ) {
                                    this.input.value =
                                        firstDisabledOption.innerText;
                                    return;
                                }
                            }
                        ...
                        _setSelectedStates() {
                            this._values.forEach((value) => {
                                ...
                                const cb = value.optionEl.querySelector(
                                    'input[type="checkbox"]'
                                );
                        ...
                        _activateOption(ul, li) {
                            if (!li) return;
                            if (!this.isMultiple)
                                ul.querySelectorAll("li.selected").forEach(
                        ...
                        getSelectedValues() {
                            return this._getSelectedOptions().map(
                                (realOption) => realOption.value
                            );
                        }
                    }
                    ...
                    class Sidenav extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleCloseTriggerClick = (e) => {
                                const closeTrigger =
                                    e.target.closest(".sidenav-close");
                            ...
                            this.options = Object.assign(
                                Object.assign({}, Sidenav.defaults),
                                options
                            );
                            this.id = this.el.id;
                            this.isOpen = false;
  ...
  \***********************/
                    ...
                    class Slider extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleInterval = () => {
                                const activeElem =
                                    this._slider.querySelector(".active");
                                let newActiveIndex = [
                                    ...activeElem.parentNode.children,
                                ].indexOf(activeElem);
                            ...
                            this._slides = Array.from(
                                this._slider.querySelectorAll("li")
                            );
                            this.activeIndex = this._slides.findIndex((li) =>
                                li.classList.contains("active")
                            );
                            if (this.activeIndex !== -1) {
                                this._activeSlide =
                                    this._slides[this.activeIndex];
                            }
                            this._setSliderHeight();
                            // Sets element id if it does not have one
                            if (this._slider.hasAttribute("id"))
                                this._sliderId =
                                    this._slider.getAttribute("id");
                            else {
                                this._sliderId =
                                    "slider-" + utils_1.Utils.guid();
        ...
        */
                        ...
                        _setSliderHeight() {
                            ...
                            if (!this.el.classList.contains("fullscreen")) {
                                if (this.options.indicators) {
                                    ...
                                    this.el.style.height =
                                        this.options.height + 40 + "px"; //.css('height', this.options.height + 40 + 'px');
                                } else {
                                    this.el.style.height =
                        ...
                        set(index) {
                            ...
                            const _caption =
                                this._activeSlide.querySelector(".caption");
                            ...
                            if (this.options.indicators) {
                                const activeIndicator =
                                    this._indicators[this.activeIndex]
                                        .children[0];
                                const nextIndicator =
                                    this._indicators[index].children[0];
                                activeIndicator.classList.remove("active");
                                nextIndicator.classList.add("active");
                                if (
                                    typeof this.options.indicatorLabelFunc ===
                                    "function"
                                ) {
                                    activeIndicator.ariaLabel =
                                        this.options.indicatorLabelFunc.call(
                                            this,
                                            this.activeIndex,
                                            false
                                        );
                                    nextIndicator.ariaLabel =
                                        this.options.indicatorLabelFunc.call(
                                            this,
                                            index,
                                            true
  ...
  \*********************/
                /***/ function (
                    ...
                    const carousel_1 = __webpack_require__(
                    ...
                    class Tabs extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleWindowResize = () => {
                                ...
                                if (
                                    ...
                                    this._indicator.style.left =
                                        this._calcLeftPos(this._activeTabLink) +
                                        "px";
                            ...
                            this._handleTabClick = (e) => {
                                ...
                                if (tabLink.hash)
                                    this._content = document.querySelector(
                                        tabLink.hash
                                    );
                                this._tabLinks =
                                    this.el.querySelectorAll("li.tab > a");
                                // Make the tab active
                                this._activeTabLink.classList.add("active");
                                const prevIndex = this._index;
                                this._index = Math.max(
                                    Array.from(this._tabLinks).indexOf(tabLink),
                                    0
                                );
                                // Swap content
                                if (this.options.swipeable) {
                                    ...
                                    if (this._content) {
                                        ...
                                        if (
                                            _oldContent &&
                                            _oldContent !== this._content
                                        ) {
                                            _oldContent.style.display = "none";
                                            _oldContent.classList.remove(
                                                "active"
                                            );
                                        }
                                    }
                        ...
                        _setupActiveTabLink() {
                            ...
                            this._activeTabLink = Array.from(
                                this._tabLinks
                            ).find(
                            ...
                            if (!this._activeTabLink) {
                                this._activeTabLink =
                                    this.el.querySelector("li.tab a.active");
                            }
                            if (this._activeTabLink.length === 0) {
                                this._activeTabLink =
                                    this.el.querySelector("li.tab a");
                            }
                            ...
                            this._activeTabLink.classList.add("active");
                            this._index = Math.max(
                                Array.from(this._tabLinks).indexOf(
                                    this._activeTabLink
                                ),
                                0
                            );
                        ...
                        _setupSwipeableTabs() {
                            ...
                            // Wrap around
                            tabsContent[0].parentElement.insertBefore(
                                tabsWrapper,
                                tabsContent[0]
                            );
                            ...
                            this._tabsCarousel = carousel_1.Carousel.init(
                                tabsWrapper,
                                {
                                    fullWidth: true,
                                    noWrap: true,
                                    onCycleTo: (item) => {
                                        ...
                                        this._activeTabLink.classList.add(
                                            "active"
                                        );
                                        this._animateIndicator(prevIndex);
                                        if (
                        ...
                        _animateIndicator(prevIndex) {
                            let leftDelay = 0,
                                rightDelay = 0;
                            if (this._index - prevIndex >= 0) leftDelay = 90;
                            else rightDelay = 90;
                            const animOptions = {
                ...
                /***/ (
                    ...
                    class TapTarget extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this.options = Object.assign(
                                Object.assign({}, TapTarget.defaults),
                                options
                            );
                            this.isOpen = false;
                            // setup
                            this._origin = document.querySelector(
                                `#${el.dataset.target}`
                            );
                            this._setup();
                            this._calculatePositioning();
                        ...
                        _setup() {
                            ...
                            if (!this.waveEl) {
                                ...
                                if (!this.originEl) {
                                    this.originEl =
                                        this._origin.cloneNode(true); // .clone(true, true);
                                    this.originEl.classList.add(
                                        "tap-target-origin"
                                    );
                        ...
                        _calculatePositioning() {
                            ...
                            let isFixed =
                                getComputedStyle(this._origin).position ===
                                "fixed";
                            if (!isFixed) {
                            ...
                            const tapTargetLeft =
                                ...
                                originWidth / 2 -
                                tapTargetWidth / 2;
                            const tapTargetPosition = isFixed
                                ? "fixed"
                                : "absolute";
                            // Calculating content
                            ...
                            this.waveEl.style.height =
                                tapTargetWaveHeight + "px";
                        }
                    }
                    ...
                    class Timepicker extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this._handleClockClickStart = (e) => {
                                e.preventDefault();
                                let clockPlateBR =
                                    this.plate.getBoundingClientRect();
                                let offset = {
                                    x: clockPlateBR.left,
                                    y: clockPlateBR.top,
                                };
                            ...
                            this._handleDocumentClickEnd = (e) => {
                                ...
                                if (this.currentView === "hours") {
                                    ...
                                    this.minutesView.classList.add(
                                        "timepicker-dial-out"
                                    );
                                    setTimeout(() => {
                                        this.done();
                            ...
                            this._handleAmPmClick = (e) => {
                                ...
                                this.amOrPm = btnClicked.classList.contains(
                                    "am-btn"
                                )
                                    ? "AM"
                                    : "PM";
                            ...
                            this.showView = (view, delay = null) => {
                                if (
                                    view === "minutes" &&
                                    getComputedStyle(this.hoursView)
                                        .visibility === "visible"
                                ) {
                                ...
                                if (isHours) {
                                    this.inputHours.classList.add(
                                        "text-primary"
                                    );
                                    this.inputMinutes.classList.remove(
                                        "text-primary"
                                    );
                                } else {
                                    this.inputHours.classList.remove(
                                        "text-primary"
                                    );
                                    this.inputMinutes.classList.add(
                                        "text-primary"
                                    );
                                }
                                // Transition view
                            ...
                            this._inputFromTextField = () => {
                                ...
                                if (isHours) {
                                    ...
                                    if (value >= 0 && value < 60) {
                                        ...
                                        this.modalEl
                                            .querySelector(
                                                ".confirmation-btns :nth-child(2)"
                                            )
                                            .focus();
                                    } else {
                                        const minutes = new Date().getMinutes();
                                        this.inputMinutes.value =
                                            Timepicker._addLeadingZero(minutes);
                                    }
                                }
                            };
                            /**
                            ...
                            this.options = Object.assign(
                                Object.assign({}, Timepicker.defaults),
                                options
                            );
                            this.id = utils_1.Utils.guid();
                            this._insertHTMLIntoDOM();
                        ...
                        _setupEventHandlers() {
                            ...
                            this.plate.addEventListener(
                                "mousedown",
                                this._handleClockClickStart
                            );
                            this.plate.addEventListener(
                                "touchstart",
                                this._handleClockClickStart
                            );
                            this.digitalClock.addEventListener(
                                "keyup",
                                this._inputFromTextField
                            );
                            this.inputHours.addEventListener("click", () =>
                                this.showView("hours")
                            );
                            this.inputMinutes.addEventListener("click", () =>
                        ...
                        _setupVariables() {
                            ...
                            this.digitalClock = this.modalEl.querySelector(
                            ...
                            this.inputHours = this.modalEl.querySelector(
                                ".timepicker-input-hours"
                            );
                            this.inputMinutes = this.modalEl.querySelector(
                        ...
                        _pickerSetup() {
                            ...
                            const confirmationBtnsContainer =
                                document.createElement("div");
                            confirmationBtnsContainer.classList.add(
                                "confirmation-btns"
                            );
                            ...
                            const doneButton = this._createButton(
                        ...
                        _clockSetup() {
                            if (this.options.twelveHour) {
                                ...
                                this._amBtn.addEventListener(
                                    "click",
                                    this._handleAmPmClick
                                );
                        ...
                        resetClock(delay) {
                            ...
                            let view = this.currentView,
                                ...
                                self = this;
                            if (delay) {
                                (_a = this.canvas) === null || _a === void 0
                                    ? void 0
                                    : _a.classList.add("timepicker-canvas-out");
                                setTimeout(() => {
                                    var _a;
                                    (_a = self.canvas) === null || _a === void 0
                                        ? void 0
                                        : _a.classList.remove(
                        ...
                        dismiss() {
                            ...
                            (0, animejs_1.default)({
                                ...
                                complete: () => {
                                    ...
                                    if (
                                        typeof this.options.completeCallback ===
                                        "function"
                                    ) {
                    ...
                    class Tooltip extends component_1.Component {
                        constructor(el, options) {
                            ...
                            this.open = (isManual) => {
                                if (this.isOpen) return;
                                isManual =
                                    isManual === undefined ? true : undefined; // Default value true
                                this.isOpen = true;
                            ...
                            this.options = Object.assign(
                                Object.assign({}, Tooltip.defaults),
                                options
                            );
                            this.isOpen = false;
                            this.isHovered = false;
                        ...
                        _repositionWithinScreen(x, y, width, height) {
                            ...
                            const offset =
                                this.options.margin +
                                this.options.transitionMovement;
                            const edges = utils_1.Utils.checkWithinContainer(
                                document.body,
                                bounding,
                                offset
                            );
                ...
                /***/ (__unused_webpack_module, exports) => {
                    ...
                    class Utils {
                        ...
                        static checkWithinContainer(
                            ...
                            if (
                                scrolledX < containerRect.left + offset ||
                                scrolledX < offset
                            ) {
                                edges.left = true;
                            }
                            if (
                                scrolledX + bounding.width >
                            ...
                            if (
                                scrolledY < containerRect.top + offset ||
                                scrolledY < offset
                            ) {
                                edges.top = true;
                            }
                            if (
                                scrolledY + bounding.height >
                                    containerBottom - offset ||
                                scrolledY + bounding.height >
                        ...
                        static checkPossibleAlignments(
                            ...
                            canAlign.spaceOnRight = !containerAllowsOverflow
                                ...
                                : window.innerWidth -
                                  (elOffsetRect.left + bounding.width);
                            ...
                            canAlign.spaceOnBottom = !containerAllowsOverflow
                                ? containerHeight -
                                  (scrolledYTopEdge + bounding.height + offset)
                                : window.innerHeight -
                                    ...
                                    document.body.addEventListener(
                                        ...
                                        (e) => {
                                            ...
                                            if (el && el.contains(trigger)) {
                                                ...
                                                const x =
                                                    e.pageX -
                                                    Waves._offset(el).left;
                                                const y =
                                                    e.pageY -
                                                    Waves._offset(el).top;
                                                let color = null;
                                                if (
                                                    el.classList.contains(
                                                        "waves-light"
  ...
  \***********************/
            ...
            const buttons_1 = __webpack_require__(
                /*! ./buttons */ "./src/buttons.ts"
            );
            const cards_1 = __webpack_require__(
                /*! ./cards */ "./src/cards.ts"
            );
            const carousel_1 = __webpack_require__(
                /*! ./carousel */ "./src/carousel.ts"
            );
            const characterCounter_1 = __webpack_require__(
                /*! ./characterCounter */ "./src/characterCounter.ts"
            );
            const chips_1 = __webpack_require__(
                /*! ./chips */ "./src/chips.ts"
            );
            const collapsible_1 = __webpack_require__(
                /*! ./collapsible */ "./src/collapsible.ts"
            );
            const datepicker_1 = __webpack_require__(
                /*! ./datepicker */ "./src/datepicker.ts"
            );
            const dropdown_1 = __webpack_require__(
                /*! ./dropdown */ "./src/dropdown.ts"
            );
            const forms_1 = __webpack_require__(
                /*! ./forms */ "./src/forms.ts"
            );
            const materialbox_1 = __webpack_require__(
                /*! ./materialbox */ "./src/materialbox.ts"
            );
            const modal_1 = __webpack_require__(
                /*! ./modal */ "./src/modal.ts"
            );
            const parallax_1 = __webpack_require__(
                /*! ./parallax */ "./src/parallax.ts"
            );
            const pushpin_1 = __webpack_require__(
                /*! ./pushpin */ "./src/pushpin.ts"
            );
            const scrollspy_1 = __webpack_require__(
                /*! ./scrollspy */ "./src/scrollspy.ts"
            );
            const select_1 = __webpack_require__(
                /*! ./select */ "./src/select.ts"
            );
            const sidenav_1 = __webpack_require__(
                /*! ./sidenav */ "./src/sidenav.ts"
            );
            const slider_1 = __webpack_require__(
                /*! ./slider */ "./src/slider.ts"
            );
            const tabs_1 = __webpack_require__(/*! ./tabs */ "./src/tabs.ts");
            const tapTarget_1 = __webpack_require__(
                /*! ./tapTarget */ "./src/tapTarget.ts"
            );
            const timepicker_1 = __webpack_require__(
                /*! ./timepicker */ "./src/timepicker.ts"
            );
            const toasts_1 = __webpack_require__(
                /*! ./toasts */ "./src/toasts.ts"
            );
            const tooltip_1 = __webpack_require__(
                /*! ./tooltip */ "./src/tooltip.ts"
            );
            const waves_1 = __webpack_require__(
                /*! ./waves */ "./src/waves.ts"
            );
            const range_1 = __webpack_require__(
                /*! ./range */ "./src/range.ts"
            );
            const utils_1 = __webpack_require__(
                /*! ./utils */ "./src/utils.ts"
            ...
            class M {
                ...
                static AutoInit(context = document.body) {
                    let registry = {
                        Autocomplete: context.querySelectorAll(
                            ".autocomplete:not(.no-autoinit)"
                        ),
                        Carousel: context.querySelectorAll(
                            ".carousel:not(.no-autoinit)"
                        ),
                        Chips: context.querySelectorAll(
                            ".chips:not(.no-autoinit)"
                        ),
                        Collapsible: context.querySelectorAll(
                            ".collapsible:not(.no-autoinit)"
                        ),
                        Datepicker: context.querySelectorAll(
                            ".datepicker:not(.no-autoinit)"
                        ),
                        Dropdown: context.querySelectorAll(
                            ".dropdown-trigger:not(.no-autoinit)"
                        ),
                        Materialbox: context.querySelectorAll(
                            ".materialboxed:not(.no-autoinit)"
                        ),
                        Modal: context.querySelectorAll(
                            ".modal:not(.no-autoinit)"
                        ),
                        Parallax: context.querySelectorAll(
                            ".parallax:not(.no-autoinit)"
                        ),
                        Pushpin: context.querySelectorAll(
                            ".pushpin:not(.no-autoinit)"
                        ),
                        ScrollSpy: context.querySelectorAll(
                            ".scrollspy:not(.no-autoinit)"
                        ),
                        FormSelect: context.querySelectorAll(
                            "select:not(.no-autoinit)"
                        ),
                        Sidenav: context.querySelectorAll(
                            ".sidenav:not(.no-autoinit)"
                        ),
                        Tabs: context.querySelectorAll(
                            ".tabs:not(.no-autoinit)"
                        ),
                        TapTarget: context.querySelectorAll(
                            ".tap-target:not(.no-autoinit)"
                        ),
                        Timepicker: context.querySelectorAll(
                            ".timepicker:not(.no-autoinit)"
                        ),
                        Tooltip: context.querySelectorAll(
                            ".tooltipped:not(.no-autoinit)"
                        ),
                        FloatingActionButton: context.querySelectorAll(
            ...
            (() => {
                document.addEventListener(
                    "keydown",
                    utils_1.Utils.docHandleKeydown,
                    true
                );
                document.addEventListener(
                    "keyup",
                    utils_1.Utils.docHandleKeyup,
                    true
                );
                document.addEventListener(
                    "focus",
                    utils_1.Utils.docHandleFocus,
                    true
                );
                document.addEventListener(
                    "blur",
                    utils_1.Utils.docHandleBlur,
                    true
                );
                cards_1.Cards.Init();
                forms_1.Forms.Init();
